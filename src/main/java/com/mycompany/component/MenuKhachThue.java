...
public class MenuKhachThue extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        listMenu1.addItem(new Model_Menu("2", "Thanh toán", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("8", "Lịch sử thanh toán", Model_Menu.MenuType.MENU));
